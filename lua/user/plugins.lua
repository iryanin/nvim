...
require("lazy").setup({
	...
	{ "lukas-reineke/indent-blankline.nvim" },
	{
		...
		config = function()
			...
			dap.adapters.lldb = {
				type = "executable",
				command = "/opt/homebrew/Cellar/llvm/16.0.1/bin/lldb-vscode", -- adjust as needed, must be absolute path
				name = "lldb",
			}
		...
		config = function()
			require("code_runner").setup({
				filetype = {
					...
					c = "cd $dir && clang -g -Wl,-stack_size -Wl,0x10000000 -Wextra -fsanitize=address -Wall -Wsign-compare -Wwrite-strings -Wtype-limits $fileName -o $fileNameWithoutExt && time $dir/$fileNameWithoutExt",
					cpp = "cd $dir && clang++ -g -Wextra -fsanitize=address -Wall -Wsign-compare -Wwrite-strings -Wtype-limits $fileName -o $fileNameWithoutExt && time $dir/$fileNameWithoutExt",
					python = "time python3 -u",
					typescript = "time deno run",
					sh = "zsh",
					rust = "cd $dir && rustc $fileName && time $dir/$fileNameWithoutExt",
					markdown = "pandoc -f markdown --pdf-engine=xelatex --listings --template eisvogel $fileName -o $fileNameWithoutExt.pdf",
				},
			})
		end,
	},
